...
namespace Q_A.DAL.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Votes_UserId_QuestionId_AnswerId_CommentId",
                table: "Votes",
                columns: new[] { "UserId", "QuestionId", "AnswerId", "CommentId" },
                unique: true,
                filter: "[QuestionId] IS NOT NULL AND [AnswerId] IS NOT NULL AND [CommentId] IS NOT NULL");
